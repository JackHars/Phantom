...
/* long_constr_h_e_fun_jac_uxt_zt:(i0[3],i1[],i2[],i3[3])->(o0[4],o1[3x4,5nz],o2[4x0]) */
...
CASADI_SYMBOL_EXPORT int long_constr_h_e_fun_jac_uxt_zt_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
